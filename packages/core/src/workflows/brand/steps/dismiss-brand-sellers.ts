...
type DismissBrandSellersStepInput = {
  brand_id: string
  seller_ids: string[]
}

export const dismissBrandSellersStep = createStep(
  "dismiss-brand-sellers",
  async (input: DismissBrandSellersStepInput, { container }) => {
